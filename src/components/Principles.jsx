...
const principles = [
  {
    ...
    desc: 'Give me the problem, not a task list. I find the path, flag risks early, and ship — you don\'t chase me.',
  },
  {
    num: '02',
    title: 'SECURITY IS NOT AN AFTERTHOUGHT',
    desc: 'RBAC, Maker-Checker, Spring Security, Azure AD — I wire in the right security pattern before the first line of business logic.',
  },
  {
    num: '03',
